...
public class ArchaeologyTableMenu extends AbstractContainerMenu {
    ...
    public ArchaeologyTableMenu(int id, Inventory playerInventory) {
        super(BignayMenus.ARCHAEOLOGY_TABLE_MENU.get(), id);
        ...
        this.addSlot(new Slot(container, 1, 76, 23) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return stack.getItem() == BignayItems.POTTER_SHERD.get();
            }
        });
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            if (index == 2) {
                ...
                } else if (original.getItem() == BignayItems.POTTER_SHERD.get()) {
    ...
    private void updateResult() {
        ...
        if (!slot0.isEmpty() && !slot1.isEmpty() && slot0.is(BignayTags.Items.POTTERY_SHERDS) && slot1.getItem() == BignayItems.POTTER_SHERD.get()) {
