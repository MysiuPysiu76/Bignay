...
//                BignayConfig.SCREENSHOTS_VIEWER_SHOW_FILE_NAME.get()
                        true? Minecraft.getInstance().font.lineHeight + 4 : 0) +
//                BignayConfig.SCREENSHOTS_VIEWER_GAP.get()
               4 + Math.max(1, (int)(Math.max(1, ((width - 50) - (
//                       BignayConfig.SCREENSHOTS_VIEWER_COLUMNS.get()
                                4- 1) * 4
//                BignayConfig.SCREENSHOTS_VIEWER_GAP.get()
        ) / 5
//                BignayConfig.SCREENSHOTS_VIEWER_COLUMNS.get()
...
//        this.gap = BignayConfig.SCREENSHOTS_VIEWER_GAP.get();
        ...
        this.textHeight = Math.max(0,
//                BignayConfig.SCREENSHOTS_VIEWER_SHOW_FILE_NAME.get()
                         true? this.minecraft.font.lineHeight + 4 : 0);
    }
