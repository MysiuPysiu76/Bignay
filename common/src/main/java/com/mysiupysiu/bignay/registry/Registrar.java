...
public class Registrar<T> {
    ...
    public static class Entry<T> implements RegistrySupplier<T> {
        ...
        // Zamiast trzymać twardą wartość 'T value', używamy suppliera.
        // Pozwala to Forge'owi na wstrzyknięcie RegistryObject.
        ...
        // Metoda do bezpośredniego przypisania (używana przez Fabric)
        public void set(T value) {
            this.resolvedSupplier = () -> value;
        }

        // Nowa metoda dla Forge'a do przypisania RegistryObject
